...
__layouts'__: This folder contains the basic HTML that serves as the template for the different categories of pages on your site. Jekyll takes the Markdown content of your individual posts or pages and thenThese files are all written in HTML, and if you’d like to change the order of information on your site, or play around with its basic layout, you’ll need to edit these pages using HTML. You certainly don’t have to--these pages will work fine just as they are--but if you’d like to, there are basic HTML tutorials available for free on the web, like this one from CodeAcademy, and this one from Mozilla.
